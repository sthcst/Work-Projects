#!/usr/bin/env python3
"""Generate 1000 diverse test emails with realistic PII."""
...
# Output directory
OUTPUT_DIR = Path('test_emails_1000')
...
print(f"Generating 1000 test emails with diverse PII...")

for email_idx in range(1, 1001):
    ...
    # Write to file
    output_file = OUTPUT_DIR / f"email_{email_idx:04d}.txt"
    output_file.write_text(email_content, encoding='utf-8')
    
    if email_idx % 100 == 0:
        print(f"  Generated {email_idx}/1000 emails...")

print(f"\n✅ Successfully generated 1000 test emails in {OUTPUT_DIR}/")
